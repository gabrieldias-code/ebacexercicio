...
Funcionalidade: Finalização de compra
  ...
  Cenário: Finalização de compra bem-sucedida
    ...
    E preencher o endereço de entrega
    E selecionar a forma de pagamento "Cartão de crédito"
    Então o sistema deve confirmar o pedido
    E exibir a mensagem "Compra realizada com sucesso!"

  Esquema do Cenário: Tentativa de compra com dados incompletos
    Quando o cliente clicar em "Finalizar compra"
    E não preencher o campo "<campo>"
